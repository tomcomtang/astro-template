 ...
 */
export function createSimpleServerPackageJson(serverDir) {
    ...
    writeFileSync(join(serverDir, 'package.json'), JSON.stringify(serverPackageJson, null, 2));
}
 ...
 */
function getRedirectLocation(route, base) {
 ...
 */
function getRedirectSource(route, base) {
    if (route.segments) {
